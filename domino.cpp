...
void CreateVBO(void)
{
    ...
    // in ce ordine sa se ia punctele pt ca formam triunghiuri
    GLuint Indices[] = {
      2, 0, 3,
      0, 1, 2
    };
    ...
    // se activeaza lucrul cu atribute; atributul 2 = coordonate de texturare (a 7-a)
...
void RenderFunction(void)
{
    ...
    {
        // cat de stanga sau dreapta sa fie
        matrTransl = glm::translate(glm::vec3(15.0f * (piece_index - no_pieces / 2), 0.0f, 0.0f));

        GLfloat maxAngle = -50.f;

        //creaza o matricie de rotatie
        // in funcite de frame si piesa rotim piesa pana la unghiul indicat mai sus
        matrRot1 = glm::rotate(glm::mat4(1.0f), glm::radians(min(max((-frame * speed + 18 * piece_index), maxAngle), 0.f)), glm::vec3(0.0, 0.0, 1.0));
        //matrRot1 = glm::rotate(glm::mat4(1.0f), glm::radians((-frame * speed + 18 * piece_index)), glm::vec3(0.0, 0.0, 1.0));
